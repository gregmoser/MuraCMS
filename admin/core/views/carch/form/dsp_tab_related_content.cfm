			...
			<cfloop from="1" to="#arrayLen(relatedContentSets)#" index="s">
				...
				<cfoutput>
					<div id="rcGroup-#rcsBean.getRelatedContentSetID()#" class="list-table">
						<div class="list-table-content-set">#rcsBean.getName()# <cfif len(rcsBean.getAvailableSubTypes()) gt 0><span class="content-type">Restricted to: <i class="#subtype.getIconClass()#"></i> <strong>#replace(rcsBean.getAvailableSubTypes(), ",", ", ", "all")#</strong></span></cfif></div>
