...
<h3>#HTMLEditFormat(chain.getName())#</h3>
<p>#HTMLEditFormat(chain.getDescription())#</p>
		        ...
		        <tr>  
		          ...
		          <cfif hasChangesets>
		          	<td>
		          		...
		          		<a href="./?muraAction=cChangesets.assignments&siteID=#item.getSiteID()#&changesetID=#item.getChangeSetID()#">#HTMLEditFormat(item.getChangesetName())#</a></td>
		          </cfif>
		          <td>#HTMLEditFormat(item.getLastUpdateBy())#</td>
